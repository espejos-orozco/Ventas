...
// Model for Productos entity
    models.Productos = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/VentasOnlinev2/webresources/entities.productos/",
        ...
        toViewJson: function () {
            ...
            result.displayName = this.get('productoId');
            return result;
        },
        isNew: function () {
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/VentasOnlinev2/webresources/entities.productos/';
            }
    ...
    models.ProductosCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/VentasOnlinev2/webresources/entities.productos/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
